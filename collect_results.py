...
METHOD_STYLE = {
    ...
    "r2_router":       {"color": "#4CAF50", "linestyle": "-",  "linewidth": 2.0, "marker": "^"},
    "cscr":            {"color": "#795548", "linestyle": "-",  "linewidth": 2.0, "marker": "*"},
}
METHOD_LABEL = {
    "random":          "Random",
    "mf":              "MF Router",
    ...
    "r2_router":       "R2-Router (per-model)",
    "cscr":            "CSCR (contrastive KNN)",
}
...
def make_graphs(entries: list[dict], output_png: str, include_random: bool = False) -> str:
    ...
    """
    methods = (["random"] if include_random else []) + ["mf", "uniroute", "uniroute_train", "uni_r2", "uniroute_legacy", "r2_router", "cscr"]
    # pair 순서 보존
